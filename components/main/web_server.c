...
esp_err_t handle_camera_status_get(httpd_req_t *req)
{
    ...
    switch (pixel_format) {
        case 0x01080001: format_name = "Mono8"; break;
        case 0x02100005: format_name = "RGB565Packed"; break;
        case 0x02100004: format_name = "YUV422Packed"; break;
        case 0x02180014: format_name = "RGB8Packed"; break;
        case 0x80000001: format_name = "JPEG"; break;
